...
DR_6850 	    :=      $A001  	       ; rx data when reading and tx data when sending
...
MYRUN:            JSR     ACTRUN         ;* JSR to the Address we want to run
...
MSG1:
            .byte $0C, "Welcome to Rob's EWOZ 1.0.", $0D, $0A,$00
MSG2:
            .byte $0C, "Start Intel Hex code Transfer.", $0D, $0A, $00
MSG3:
            .byte $0C, "Intel Hex Imported OK.", $0D, $0A, $00
MSG4:
            .byte $0C, "Intel Hex Imported with checksum error.", $0D, $0A, $00  
;;-------------------------------------------------------------------------
;;  Vector area
;;-------------------------------------------------------------------------
;            ORG $FFFA
...
StartupMessage:
	.byte	$0C,"Cold [C] or warm [W] start? or Mon[M]",$0D,$0A,$00
CMessage:
	.byte	$0C,"Cold [C] typed.",$0D,$0A,$00
WMessage:
	.byte	$0C,"Warm [W] typed.",$0D,$0A,$00
MMessage:
	.byte	$0C,"Mon [M] typed.",$0D,$0A,$00
